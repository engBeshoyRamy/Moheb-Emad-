...
const SKILL_GROUPS = [
  {
    ...
    icon: '◎',
    color: 'var(--blue)',
    colorDim: 'rgba(32,0,234,0.12)',
    borderColor: 'rgba(32,0,234,0.3)',
    skills: [
      'Sound Design',
      'Mixing & Mastering',
      'Audio Editing',
  ...
  },
  {
    ...
    icon: '◈',
    color: 'var(--lav)',
    colorDim: 'rgba(158,146,231,0.1)',
    borderColor: 'rgba(158,146,231,0.28)',
    skills: [
      'Pro Tools',
      'Cubase',
      'Ableton Live',
...
function SkillCard({ group, groupIndex }) {
  return (
    <AnimatedSection delay={groupIndex * 0.12}>
      ...
      >
        {/* Top accent on hover — always rendered, fades via opacity */}
        <div
          aria-hidden="true"
          style={{
            position: 'absolute',
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 1300, margin: '0 auto', padding: '0 clamp(20px, 5vw, 64px)' }}>
          ...
          >
            ...
            {[
              ...
              >
                <span
                  aria-hidden="true"
                  style={{ fontSize: '0.8rem', color: 'var(--blue)', opacity: 0.7 }}
                >
                  {stat.icon}
                </span>
                <span
        ...
        {/* Tools marquee (existing, unchanged) */}
            ...
            >
              {[...TOOLS, ...TOOLS].map((tool, i) => (
                <motion.span
                  ...
                  whileHover={{
                    borderColor: 'rgba(32,0,234,0.4)',
                    color: 'var(--lav)',
                    backgroundColor: 'rgba(32,0,234,0.06)',
                  }}
